...
var _tripokey$elm_fuzzy$Main$viewElement = function (_p0) {
	var _p1 = _p0;
	var _p5 = _p1._0;
	var isMatch = function (index) {
		return A3(
			...
			F2(
				function (e, sum) {
					return _elm_lang$core$Basics$not(sum) ? ((_elm_lang$core$Native_Utils.cmp(e.offset, index) < 1) && (_elm_lang$core$Native_Utils.cmp(e.offset + e.length, index) > 0)) : sum;
				}),
			false,
			_p5.matches);
	};
	var bgColor = function (index) {
		return isMatch(index) ? _elm_lang$core$Native_List.fromArray(
			[
	...
	var isKey = function (index) {
		return A3(
			...
			F2(
				function (e, sum) {
					return _elm_lang$core$Basics$not(sum) ? A2(_elm_lang$core$List$member, index - e.offset, e.keys) : sum;
				}),
			false,
			_p5.matches);
	};
	var color = function (index) {
		return isKey(index) ? _elm_lang$core$Native_List.fromArray(
			[
	...
	return A2(
		...
		_elm_lang$core$Native_List.fromArray(
			[
				...
				_elm_lang$core$Native_List.fromArray(
					[]),
				_elm_lang$core$Basics$fst(highlight))
			]));
};
var _tripokey$elm_fuzzy$Main$viewHayStack = function (model) {
	var processCase = function (item) {
		return model.caseInsensitive ? _elm_lang$core$String$toLower(item) : item;
	};
	var separators = A2(
		_elm_lang$core$List$map,
		_elm_lang$core$String$fromChar,
		_elm_lang$core$String$toList(
			processCase(model.separators)));
	var needle = processCase(model.needle);
	var scoredHays = A2(
		_elm_lang$core$List$map,
		function (hay) {
			return {
	...
	return A2(
		...
		_elm_lang$core$Native_List.fromArray(
			[]),
		A2(_elm_lang$core$List$map, _tripokey$elm_fuzzy$Main$viewElement, sortedHays));
};
var _tripokey$elm_fuzzy$Main$update = F2(
		...
		switch (_p6.ctor) {
			...
			case 'CaseFlip':
				return _elm_lang$core$Native_Utils.update(
					model,
					{
						caseInsensitive: _elm_lang$core$Basics$not(model.caseInsensitive)
					});
			default:
				return _elm_lang$core$Native_Utils.update(
					model,
					{
						prototype: '',
						haystack: A2(_elm_lang$core$List_ops['::'], model.prototype, model.haystack)
					});
		}
	});
var _tripokey$elm_fuzzy$Main$Model = F5(
	function (a, b, c, d, e) {
		return {needle: a, prototype: b, separators: c, caseInsensitive: d, haystack: e};
	});
var _tripokey$elm_fuzzy$Main$init = A5(
	_tripokey$elm_fuzzy$Main$Model,
	'',
	'',
	'',
	true,
	_elm_lang$core$Native_List.fromArray(
		['item', 'A complete sentance is this.', '/var/log/syslog/messages', 'evancz/elm-html', 'Oil', 'Firstname Lastname', 'Bread', 'if x == 5 then print 11 else print 23;', 'for (std::list<std::string>::const_iterator l_it=l_list.begin(); l_it != l_list.end(); ++l_it) {}', 'var x = 15']));
var _tripokey$elm_fuzzy$Main$Add = {ctor: 'Add'};
var _tripokey$elm_fuzzy$Main$CaseFlip = {ctor: 'CaseFlip'};
var _tripokey$elm_fuzzy$Main$Separate = function (a) {
	return {ctor: 'Separate', _0: a};
};
var _tripokey$elm_fuzzy$Main$Update = function (a) {
	return {ctor: 'Update', _0: a};
};
var _tripokey$elm_fuzzy$Main$viewAdd = function (model) {
	return A2(
		_elm_lang$html$Html$div,
		_elm_lang$core$Native_List.fromArray(
			[]),
			...
			[
				...
				_elm_lang$core$Native_List.fromArray(
					[
						...
						function (e) {
							return _tripokey$elm_fuzzy$Main$Update(e);
						}),
				...
				_elm_lang$core$Native_List.fromArray(
					[
						_elm_lang$html$Html_Events$onClick(_tripokey$elm_fuzzy$Main$Add)
					]),
				_elm_lang$core$Native_List.fromArray(
					[
...
var _tripokey$elm_fuzzy$Main$Filter = function (a) {
	return {ctor: 'Filter', _0: a};
};
var _tripokey$elm_fuzzy$Main$viewFilter = function (model) {
	var caseText = model.caseInsensitive ? 'Case insensitive' : 'Case sensitive';
	return A2(
		_elm_lang$html$Html$div,
		_elm_lang$core$Native_List.fromArray(
			[]),
			...
			[
				...
				_elm_lang$core$Native_List.fromArray(
					[
						_elm_lang$html$Html_Events$onInput(
						function (e) {
							return _tripokey$elm_fuzzy$Main$Filter(e);
						}),
				...
				_elm_lang$core$Native_List.fromArray(
					[
						_elm_lang$html$Html_Events$onInput(
						function (e) {
							return _tripokey$elm_fuzzy$Main$Separate(e);
						}),
						_elm_lang$html$Html_Attributes$placeholder('Separators')
					]),
				_elm_lang$core$Native_List.fromArray(
					[])),
				A2(
				...
				_elm_lang$core$Native_List.fromArray(
					[
						_elm_lang$html$Html_Events$onClick(_tripokey$elm_fuzzy$Main$CaseFlip)
					]),
				_elm_lang$core$Native_List.fromArray(
					[
						_elm_lang$html$Html$text(caseText)
					]))
			]));
};
var _tripokey$elm_fuzzy$Main$view = function (model) {
	return A2(
		_elm_lang$html$Html$div,
		_elm_lang$core$Native_List.fromArray(
			[]),
		_elm_lang$core$Native_List.fromArray(
			[
				_tripokey$elm_fuzzy$Main$viewFilter(model),
				_tripokey$elm_fuzzy$Main$viewHayStack(model),
				_tripokey$elm_fuzzy$Main$viewAdd(model)
			]));
};
var _tripokey$elm_fuzzy$Main$main = {
	main: _elm_lang$html$Html_App$beginnerProgram(
		{model: _tripokey$elm_fuzzy$Main$init, update: _tripokey$elm_fuzzy$Main$update, view: _tripokey$elm_fuzzy$Main$view})
};

var Elm = {};
Elm['Main'] = Elm['Main'] || {};
_elm_lang$core$Native_Platform.addPublicModule(Elm['Main'], 'Main', typeof _tripokey$elm_fuzzy$Main$main === 'undefined' ? null : _tripokey$elm_fuzzy$Main$main);
