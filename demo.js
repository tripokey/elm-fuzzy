		...
		switch (_p6.ctor) {
			...
			default:
				return _elm_lang$core$Native_Utils.update(
					...
					{
						prototype: '',
						haystack: {ctor: '::', _0: model.prototype, _1: model.haystack}
					});
		}
	});
...
var _tripokey$elm_fuzzy$Main$init = A5(
	...
	true,
	{
		...
		_1: {
			ctor: '::',
			_0: 'A complete sentance is this.',
			_1: {
				ctor: '::',
				_0: '/var/log/syslog/messages',
				_1: {
					ctor: '::',
					_0: 'evancz/elm-html',
					_1: {
						...
						_1: {
							ctor: '::',
							_0: 'Firstname Lastname',
							_1: {
								ctor: '::',
								_0: 'Bread',
								_1: {
									ctor: '::',
									_0: 'if x == 5 then print 11 else print 23;',
									_1: {
										ctor: '::',
										_0: 'for (std::list<std::string>::const_iterator l_it=l_list.begin(); l_it != l_list.end(); ++l_it) {}',
										_1: {
											ctor: '::',
											_0: 'var x = 15',
											_1: {ctor: '[]'}
		...
		{ctor: '[]'},
		{
			...
			_0: A2(
				_elm_lang$html$Html$input,
				{
					...
					_1: {
						ctor: '::',
						_0: _elm_lang$html$Html_Attributes$placeholder('Item'),
						_1: {ctor: '[]'}
					}
				},
				{ctor: '[]'}),
			_1: {
				...
				_0: A2(
					...
					{
						ctor: '::',
						_0: _elm_lang$html$Html_Events$onClick(_tripokey$elm_fuzzy$Main$Add),
						_1: {ctor: '[]'}
					},
					{
						ctor: '::',
			...
			_1: {
				...
				_0: A2(
					_elm_lang$html$Html$input,
					{
						...
						_1: {
							ctor: '::',
							_0: _elm_lang$html$Html_Attributes$placeholder('Separators'),
							_1: {ctor: '[]'}
						}
					},
					{ctor: '[]'}),
				_1: {
					...
					_0: A2(
						...
						{
							ctor: '::',
							_0: _elm_lang$html$Html_Events$onClick(_tripokey$elm_fuzzy$Main$CaseFlip),
							_1: {ctor: '[]'}
						},
						{
							ctor: '::',
							_0: _elm_lang$html$Html$text(caseText),
							_1: {ctor: '[]'}
						}),
					_1: {ctor: '[]'}
				}
...
var _tripokey$elm_fuzzy$Main$view = function (model) {
	return A2(
		...
		{
			ctor: '::',
			_0: _tripokey$elm_fuzzy$Main$viewFilter(model),
			_1: {
				ctor: '::',
				_0: _tripokey$elm_fuzzy$Main$viewHayStack(model),
				_1: {
					ctor: '::',
					_0: _tripokey$elm_fuzzy$Main$viewAdd(model),
					_1: {ctor: '[]'}
				}
			}
		});
};
var _tripokey$elm_fuzzy$Main$main = _elm_lang$html$Html$beginnerProgram(
	{model: _tripokey$elm_fuzzy$Main$init, update: _tripokey$elm_fuzzy$Main$update, view: _tripokey$elm_fuzzy$Main$view})();

var Elm = {};
Elm['Main'] = Elm['Main'] || {};
if (typeof _tripokey$elm_fuzzy$Main$main !== 'undefined') {
    _tripokey$elm_fuzzy$Main$main(Elm['Main'], 'Main', undefined);
}
